...
public class EditProductController extends HttpServlet {
    ...
    try {
        ...
        String[] updateImage = request.getParameterValues("picture");
        ...
        String image = "";
        if (updateImage != null) {
            for (String img : updateImage) {
                image += "img/product/" + img + " ";
            }
        }

        if (valid) {
            Product pro = new Product(productID, updateName, upPrice, upQuantity, image.trim(), updateBrand);
