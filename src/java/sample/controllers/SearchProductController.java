    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (listProduct.size() > 0) {
                request.setAttribute("PRODUCT_LIST2", listProduct); 
                url = SUCCESS;
                 request.setAttribute("ERROR_SUCCESS", "SEARCH PRODUCTS:");
            }else{
                 request.setAttribute("ERROR_MESSAGE", "THERE ARE NO PRODUCT YOU ARE LOOKING FOR");
            }
        } catch (Exception e) {
...
//    private static String SUCCESS = "searchProduct.jsp";
//    
//    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
//            throws ServletException, IOException {
//        response.setContentType("text/html;charset=UTF-8");
...
//            String search = request.getParameter("searchProduct");
//            ProductDAO dao = new ProductDAO();
//            List<Product> listpro = dao.getListProduct(search);
//            if(listpro.size() > 0){
//                request.setAttribute("LIST_PRODUCT", listpro);
//                url = SUCCESS;
//            }
//        } catch (Exception e) {
//            log("Error at SearchProduct Controller: " + e.toString());
//        }finally{
//            request.getRequestDispatcher(url).forward(request, response);
//        }
//    }
